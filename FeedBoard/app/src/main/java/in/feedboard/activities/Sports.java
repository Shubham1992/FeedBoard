...
RecyclerView rvSports;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rvSports = (RecyclerView) rootView.findViewById(R.id.rvSports);
		...
		tvLoading = (TextView) rootView.findViewById(R.id.tvLoadingsports);

		rvSports.setLayoutManager(layoutManager2);
		makeJsonObjReq();
		return rootView;
	}
				...
				new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						...
						try
						{
							...
							Log.e("sports response", list.toString());
